...
/** \brief crea una nueva lista con los elementos que pasan el filtro de pFunc
 *
 * \param array del LinkedList
 * \param funcion que se encarga del filtrado
 * \return si pFunc devuelve 1 carga el elemento a la nueva listo, de lo contrario no
 *
 */
...
int ll_count(LinkedList* this, int(*pFunc)(void* x))
{
    int len;
    int contador = 0;
    void* auxElement;
